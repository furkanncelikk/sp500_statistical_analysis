...
<div class="container">
    <div class="grid">
        ...
        <a href="H5_Sector_Correlation.html" class="card">
            <h2>H5: Sektör Korelasyonu</h2>
            <p>S&P 500 GICS sektörleri arasında portföy çeşitlendirmesi sunacak düşük korelasyonlu ilişkiler var mıdır?</p>
            <div class="tag">Pearson Isı Haritası</div>
        </a>
